    ...
    <div className="min-h-screen bg-ink-950 text-ink-100 font-body selection:bg-red-500/30">
      ...
      <main className="pt-40 pb-20 px-6 max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-ink-50 uppercase tracking-tighter mb-4">Security Protocol</h1>
        ...
        <div className="space-y-12">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-ink-900/40 border border-ink-600">
              <Server className="w-6 h-6 text-teal-400 mb-6" />
              <h3 className="text-lg font-black text-ink-50 uppercase mb-3">Infrastructure</h3>
            ...
            <div className="p-8 rounded-3xl bg-ink-900/40 border border-ink-600">
              ...
              <h3 className="text-lg font-black text-ink-50 uppercase mb-3">Rate Limiting</h3>
              <p className="text-sm text-ink-500 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-black text-ink-50 uppercase tracking-tight mb-4">Access Control</h2>
            <p className="text-ink-400 leading-relaxed">
