    ...
    <div className="min-h-screen bg-ink-950 text-ink-100 font-body selection:bg-red-500/30">
      ...
      <main className="pt-40 pb-20 px-6 max-w-4xl mx-auto">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-ink-50 uppercase tracking-tighter mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-12">
          <section className="glass-card p-8 border-ink-600 bg-ink-900/20">
            <h2 className="text-xl font-black text-ink-50 uppercase tracking-tight mb-4 flex items-center gap-3">
              <EyeOff className="w-5 h-5 text-red-500" /> Non-Scraping Commitment
            </h2>
          ...
          <section>
            <h2 className="text-xl font-black text-ink-50 uppercase tracking-tight mb-4">Data Collection</h2>
            <p className="text-ink-400 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-black text-ink-50 uppercase tracking-tight mb-4">User Sovereignty</h2>
            <p className="text-ink-400 leading-relaxed">
          ...
          <section className="p-8 rounded-3xl bg-red-500/5 border border-red-500/10">
            <h2 className="text-xl font-black text-ink-50 uppercase tracking-tight mb-4 flex items-center gap-3">
              <Lock className="w-5 h-5 text-red-500" /> Security Note
            </h2>
            <p className="text-ink-400 leading-relaxed">
